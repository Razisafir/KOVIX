...
**Note** that this extension is bundled with Kovix version 1.29 and later - it doesn't need to be installed anymore.
...
This extension ships with Kovix and uses its issue tracker. Please file issue here: https://github.com/Microsoft/vscode/issues
