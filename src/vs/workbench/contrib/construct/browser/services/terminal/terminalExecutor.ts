...
import { ITerminalExecutor, ITerminalExecResult, TerminalRateLimiter, SHELL_METACHAR_BLOCKLIST, DEFAULT_COMMAND_ALLOWLIST, detectShellMetacharInArgs, isCommandInAllowlist, isPathWithinWorkspace, sanitiseForAuditLog } from '../../../../../../platform/construct/common/terminal/terminalExecutor.js';
